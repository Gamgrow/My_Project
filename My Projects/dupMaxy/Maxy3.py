...
def doooo(text):
    ...
    if text in ["exit", "quit", "stop"]:
        ...
        speak("sorry, i am not able to send email, becaause speech recognition is not aloow me")
        printtext("sorry, i am not able to send email, becaause speech recognition is not aloow me")
...
if __name__ == '__main__':
    def karo():
        ...
        # text = command()
        # doooo(text)
        speak("Sorry, Speech recognition not allow me, at this time you can do everything with the help of keyboard")
        printtext("Sorry, speech recog.. not allow me. So at this time you can do everything with the help of keyboard.")
